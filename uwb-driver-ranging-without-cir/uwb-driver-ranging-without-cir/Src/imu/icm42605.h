...
extern uint8_t USE_IMU;           //外接IMU,当检测到IMU时赋值为1
...
#define ICM40605_ID	             0x33	
#define ICM42605_IIC_ADD	       0xD0
...
extern icm42605RawData_t stAccData[], stGyroData[];
...
void IcmGetS16Data(int16_t* AccData, int16_t* GyroData);
